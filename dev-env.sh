...
echo ""
echo "To live-test the app with the real production setup:"
echo "  sudo ./dev-live.sh setup    # one-time provisioning (installs ZFS)"
echo "  ./dev-live.sh status        # service status + HTTP check"
echo "  sudo ./dev-live.sh update   # re-apply changed files + restart"
echo "  ./dev-live.sh logs -f       # follow the service logs"
echo "==============================================="